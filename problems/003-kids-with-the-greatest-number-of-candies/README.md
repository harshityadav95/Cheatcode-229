...
- Time: O(n)
- Space: O(1) to O(n)
- Python: `code.py` (`kids_with_the_greatest_number_of_candies`)
- Go: `code.go` (`Solve003`)
- Video: [YouTube search](https://www.youtube.com/results?search_query=LeetCode+1431+Kids+With+the+Greatest+Number+of+Candies+solution)
